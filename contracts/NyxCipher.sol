...
contract NyxCipher is IERC20 {
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            ...
            externalBuyback: payable(0x0000000000000000000000000000000000000000),
            staking: payable(0x0000000000000000000000000000000000000000)
        });
    ...
    bool public _hasLiqBeenAdded = true; // false;
