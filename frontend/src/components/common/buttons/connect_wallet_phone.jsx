...
const ConnectWalletPhone = () => {
                ...
                {(() => {
                  ...
                  return (
                    <div className="flex flex-col gap-2">
                      <button className="text-gray-300 items-center gap-2 flex lg:hidden"
                      ...
                      <div className="flex lg:hidden gap-2 items-center text-gray-100 font-bold" >
                      ...
                      <div className="md:hidden">
                        <button className="clipButton font-[Nippo] h-[40px] text-[15px]" onClick={openAccountModal} type="button">Disconnect</button>
                      </div>
                    </div>
                  );
                })()}
  ...
  export default ConnectWalletPhone;